...
import { idealList } from './materialAssets';
...
const material = () => {
  return (
    ...
    <div>{materials.map((item,index)=>{
      ...
      <div className="materials_subGrid">
      <div className='  materials_subContainer-ideal'>{item.itemIdeal}<div></div></div>
      ...
      <div className='  materials_subContainer-maintenance'>{item.itemMaintenance}</div>
      </div>
